...
public class Ball implements Sprite {
     ...
     *            of the ball.
     */
    public Ball(Point center, int r, Image i) {
        this.center = center;
        this.r = r;
        this.color = i;
     ...
     *            of the ball.
     */
    public Ball(int x, int y, int r, java.awt.Image color) {
     ...
     */
    public java.awt.Image getColor() {
        return this.color;
    }
    ...
    public void drawOn(DrawSurface d) {
        if (this.enemy) {
            d.drawImage((int)this.center.getX(),(int) this.center.getY() - this.color.getHeight(null), this.color);

        } else {
        d.drawImage((int)this.center.getX(),(int) this.center.getY(), this.color);
        }
    }
