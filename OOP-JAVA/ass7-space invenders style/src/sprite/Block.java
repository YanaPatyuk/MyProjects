...
@Override
     ...
     * @param a block.
     */
    private void notifyHit(Block a, Ball hitter) {
    ...
    /**
     * change place of the block.
     * @param r velocity.
     */
    public void changePlace(Velocity r) {
        this.rectangle.moveRect(r);
    }
    /**
     * add a color to block.
     * @param x place.
     * @param c color.
     */
    public void addOneColor(int x, Color c) {
        this.colorTofill = new HashMap<Integer, Color>();
        this.colorTofill.put(x, c);
    }
    /**
